...
namespace WoffDotNet.Tests
{
    public class OfficialW3CTests
    {
        ...
        [Fact]
        public void Invalid_Metadata_Well_Formed_004_CorrectException()
        {
            // arrange
            var cut = GetReader(Resources.metadata_well_formed_004);
        ...
        [Fact]
        public void Invalid_Metadata_Well_Formed_004_NoMetadata()
        {
            // arrange
            var cut = GetReader(Resources.metadata_well_formed_004);
        ...
        [Fact]
        public void Invalid_Metadata_Well_Formed_006_CorrectException()
        {
            // arrange
            var cut = GetReader(Resources.metadata_well_formed_006);
        ...
        [Fact]
        public void Invalid_Metadata_Well_Formed_006_NoMetadata()
        {
            // arrange
            var cut = GetReader(Resources.metadata_well_formed_006);
        ...
        [Fact]
        public void Invalid_Metadata_Well_Formed_007_CorrectException()
        {
            // arrange
            var cut = GetReader(Resources.metadata_well_formed_007);
        ...
        [Fact]
        public void Invalid_Metadata_Well_Formed_007_NoMetadata()
        {
            // arrange
            var cut = GetReader(Resources.metadata_well_formed_007);
        ...
        [Fact]
        public void Valid_Metadata_Schema_UniqueId_001()
        {
            // arrange
            var cut = GetReader(Resources.metadata_schema_uniqueid_001);
